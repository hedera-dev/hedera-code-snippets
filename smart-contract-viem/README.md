...
To obtain this URL, see the [JSON-RPC connections documentation](https://docs.hedera.com/hedera/tutorials/more-tutorials/json-rpc-connections/). To obtain the account, you can register in the [Hedera Portal](https://hubs.ly/Q03Yhbqh0).
